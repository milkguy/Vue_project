<template>
    <div>
                ...
                <el-table class="table" :data="orderList" border stripe >
                    ...
                    <el-table-column label="操作">
                        <template slot-scope="scope">
                            ...
                            <el-button type="success" @click="showProgressBox" icon="el-icon-location" size="mini"></el-button>
        ...
        <!-- 时间线 -->
             <el-timeline>
                <el-timeline-item
                v-for="(activity, index) in wuLiu[0].data"
                :key="index"
...
export default {
    ...
    methods:{
        ...
        async showProgressBox(){
            ...
            if(this.wuLiu[0].meta.status!==200){
                return this.$message.error('获取物流信息失败')
            }
